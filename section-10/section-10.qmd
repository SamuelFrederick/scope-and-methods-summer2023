---
title: "Section 9. Interactions and Marginal Effects"
...
First, we are usually interested in the slope of our variable of interest among different groups. This is known as the "marginal effect" of our variable of interest. 
...
emmeans(inter_mod, ~lndisbursements*incumbent_challenge_full, 
        at = list(lndisbursements = c(min(house$lndisbursements), 
                                      max(house$lndisbursements))))%>%
emmip( ~lndisbursements|incumbent_challenge_full, 
      PIs = T)
```
